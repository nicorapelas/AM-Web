  ...
  useEffect(() => {
    if (staffToEdit) {
      setFormData({
        ...
        pin: staffToEdit.pin,
        editFinancialEnabled: staffToEdit.editFinancialEnabled,
        deleteFinancialEnabled: staffToEdit.deleteFinancialEnabled,
      })
    }
  }, [staffToEdit])
